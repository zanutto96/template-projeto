...
{
    public static class AlunoStatusFilterBasicExtension
    {
        private static readonly MethodInfo OrderByMethod =
            typeof(Queryable).GetMethods().Single(method =>
           method.Name == "OrderBy" && method.GetParameters().Length == 2);
        public static IQueryable<AlunoStatus> WithBasicFilters(this IQueryable<AlunoStatus> queryBase, AlunoStatusFilter filters)
        {
        ...
        public static IQueryable<AlunoStatus> WithCustomFilters(this IQueryable<AlunoStatus> queryBase, AlunoStatusFilter filters)
        {
            var queryFilter = queryBase;
        ...
        public static IQueryable<AlunoStatus> OrderByDomain(this IQueryable<AlunoStatus> queryBase, AlunoStatusFilter filters)
        {
